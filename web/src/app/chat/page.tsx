  ...
  return (
    <div>
      ...
      <div className="card" style={{ minHeight: 240 }}>
        {history.length === 0 && (
          <p className="muted">
            Ask about a subject&apos;s protocol visits, compliance, and trips. Replies
            stream live; identifiers are de-identified before reaching the model.
          </p>
        )}
        {history.map((m, i) => (
          <div
          ...
          >
            ...
            {m.sources?.length ? (
              <div className="muted">sources: {m.sources.join(', ')}</div>
            ) : null}
          </div>
        ))}
      </div>
