    ...
    <div>
      ...
      <div className="card">
        ...
        {user ? (
          ...
          <p className="muted">
            Not signed in. <Link href="/login">Sign in</Link> to access data.
          </p>
        )}
      </div>
      ...
      <div className="card">
        ...
        {sec?.security ? (
          <ul>
            <li>
              Auth required: <b>{String(sec.security.auth_required)}</b>
            </li>
            <li>
              De-identification: <b>{String(sec.security.deidentification)}</b>
            </li>
          </ul>
        ) : (
          <p className="muted">—</p>
        ...
        {audit && (
          <p>
            Audit chain:{' '}
            <span className={'badge ' + (audit.ok ? 'ok' : 'warn')}>
